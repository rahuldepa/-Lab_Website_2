...
function switchPlayers(playerNum){
	...
	var avg_p = parseInt(players[playerNum].pass_yards)/parseInt(players[playerNum].games_played);
	document.getElementById('avg_p_yards').innerHTML = avg_p; 

	var avg_R = parseInt(players[playerNum].rushing_yards)/parseInt(players[playerNum].games_played);
	document.getElementById('avg_r_yards').innerHTML = avg_R; 

	var avg_Rec = parseInt(players[playerNum].receiving_yards)/parseInt(players[playerNum].games_played);
